...
func (device *Current12Bricklet) DeregisterCurrentCallback(callbackID uint64) {
...
func (device *Current12Bricklet) DeregisterAnalogValueCallback(callbackID uint64) {
...
func (device *Current12Bricklet) DeregisterCurrentReachedCallback(callbackID uint64) {
...
func (device *Current12Bricklet) DeregisterAnalogValueReachedCallback(callbackID uint64) {
...
func (device *Current12Bricklet) DeregisterOverCurrentCallback(callbackID uint64) {
