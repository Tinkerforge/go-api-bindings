...
func (device *IMUBrick) DeregisterAccelerationCallback(callbackID uint64) {
...
func (device *IMUBrick) DeregisterMagneticFieldCallback(callbackID uint64) {
...
func (device *IMUBrick) DeregisterAngularVelocityCallback(callbackID uint64) {
...
func (device *IMUBrick) DeregisterAllDataCallback(callbackID uint64) {
...
func (device *IMUBrick) DeregisterOrientationCallback(callbackID uint64) {
...
func (device *IMUBrick) DeregisterQuaternionCallback(callbackID uint64) {
...
func (device *IMUBrick) GetAllData() (accX int16, accY int16, accZ int16, magX int16, magY int16, magZ int16, angX int16, angY int16, angZ int16, temperature int16, err error) {    
    ...
    if len(resultBytes) > 0 {
        ...
        header.FillFromBytes(resultBytes)
        if header.ErrorCode != 0 {
            return accX, accY, accZ, magX, magY, magZ, angX, angY, angZ, temperature, BrickletError(header.ErrorCode)
        }
...
func (device *IMUBrick) GetOrientation() (roll int16, pitch int16, yaw int16, err error) {    
    ...
    if len(resultBytes) > 0 {
        ...
        header.FillFromBytes(resultBytes)
        if header.ErrorCode != 0 {
            return roll, pitch, yaw, BrickletError(header.ErrorCode)
        }
...
func (device *IMUBrick) GetQuaternion() (x float32, y float32, z float32, w float32, err error) {    
    ...
    if len(resultBytes) > 0 {
        ...
        header.FillFromBytes(resultBytes)
        if header.ErrorCode != 0 {
            return x, y, z, w, BrickletError(header.ErrorCode)
        }
...
func (device *IMUBrick) GetConvergenceSpeed() (speed uint16, err error) {    
    ...
    if len(resultBytes) > 0 {
        ...
        header.FillFromBytes(resultBytes)
        if header.ErrorCode != 0 {
            return speed, BrickletError(header.ErrorCode)
        }
...
func (device *IMUBrick) IsOrientationCalculationOn() (orientationCalculationOn bool, err error) {    
    ...
    if len(resultBytes) > 0 {
        ...
        header.FillFromBytes(resultBytes)
        if header.ErrorCode != 0 {
            return orientationCalculationOn, BrickletError(header.ErrorCode)
        }
