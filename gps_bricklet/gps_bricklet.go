...
func (device *GPSBricklet) DeregisterCoordinatesCallback(callbackID uint64) {
...
func (device *GPSBricklet) DeregisterStatusCallback(callbackID uint64) {
...
func (device *GPSBricklet) DeregisterAltitudeCallback(callbackID uint64) {
...
func (device *GPSBricklet) DeregisterMotionCallback(callbackID uint64) {
...
func (device *GPSBricklet) DeregisterDateTimeCallback(callbackID uint64) {
