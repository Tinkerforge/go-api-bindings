...
func (device *IO16V2Bricklet) DeregisterInputValueCallback(callbackID uint64) {
...
func (device *IO16V2Bricklet) DeregisterAllInputValueCallback(callbackID uint64) {
...
func (device *IO16V2Bricklet) DeregisterMonoflopDoneCallback(callbackID uint64) {
