...
func (device *IndustrialDualAnalogInBricklet) DeregisterVoltageCallback(callbackID uint64) {
...
func (device *IndustrialDualAnalogInBricklet) DeregisterVoltageReachedCallback(callbackID uint64) {
