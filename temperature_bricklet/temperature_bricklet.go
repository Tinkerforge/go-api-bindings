...
func (device *TemperatureBricklet) DeregisterTemperatureCallback(callbackID uint64) {
...
func (device *TemperatureBricklet) DeregisterTemperatureReachedCallback(callbackID uint64) {
