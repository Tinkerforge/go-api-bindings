...
func (device *RealTimeClockBricklet) DeregisterDateTimeCallback(callbackID uint64) {
...
func (device *RealTimeClockBricklet) DeregisterAlarmCallback(callbackID uint64) {
