...
func (device *VoltageBricklet) DeregisterVoltageCallback(callbackID uint64) {
...
func (device *VoltageBricklet) DeregisterAnalogValueCallback(callbackID uint64) {
...
func (device *VoltageBricklet) DeregisterVoltageReachedCallback(callbackID uint64) {
...
func (device *VoltageBricklet) DeregisterAnalogValueReachedCallback(callbackID uint64) {
