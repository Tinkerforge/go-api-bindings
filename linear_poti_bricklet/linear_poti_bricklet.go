...
func (device *LinearPotiBricklet) DeregisterPositionCallback(callbackID uint64) {
...
func (device *LinearPotiBricklet) DeregisterAnalogValueCallback(callbackID uint64) {
...
func (device *LinearPotiBricklet) DeregisterPositionReachedCallback(callbackID uint64) {
...
func (device *LinearPotiBricklet) DeregisterAnalogValueReachedCallback(callbackID uint64) {
